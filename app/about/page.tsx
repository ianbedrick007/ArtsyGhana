    ...
    <div className="min-h-screen bg-dark-white">
      ...
      <section className="bg-[#8D6B3B] text-white py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif mb-3 sm:mb-4">About ArtsyGhana</h1>
      ...
      {/* Our Story Section */}
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-dark-white">
        <div className="max-w-7xl mx-auto">
          <div className="w-12 sm:w-16 h-px bg-warm-gray mb-6 sm:mb-8 mx-auto" />
          <h2 className="text-3xl sm:text-4xl font-serif text-charcoal text-center mb-8 sm:mb-12">Our Story</h2>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
            ...
            <div className="relative aspect-[4/5] bg-light-grey flex items-center justify-center">
              <div className="text-center p-4 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-serif text-charcoal mb-3 sm:mb-4">Ghanaian Art</h3>
                <div className="w-24 h-24 sm:w-32 sm:h-32 mx-auto bg-burnished-gold/20 rounded-lg" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-dark-white">
        <div className="max-w-7xl mx-auto">
          <div className="w-12 sm:w-16 h-px bg-warm-gray mb-6 sm:mb-8 mx-auto" />
          <h2 className="text-3xl sm:text-4xl font-serif text-charcoal text-center mb-3 sm:mb-4">Our Mission & Values</h2>
          <div className="w-12 sm:w-16 h-px bg-warm-gray mt-6 sm:mt-8 mb-8 sm:mb-12 md:mb-16 mx-auto" />
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            <div className="text-center">
              <h3 className="text-xl sm:text-2xl font-serif text-charcoal mb-3 sm:mb-4">Authenticity</h3>
              <p className="text-sm sm:text-base text-warm-gray leading-relaxed">
      ...
      <section className="bg-[#8D6B3B] text-white py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-serif text-center mb-8 sm:mb-12 md:mb-16">Get In Touch</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            <div className="text-center">
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 md:px-8 bg-dark-white">
        <div className="max-w-4xl mx-auto">
          <div className="w-12 sm:w-16 h-px bg-warm-gray mb-6 sm:mb-8 mx-auto" />
          <h2 className="text-3xl sm:text-4xl font-serif text-charcoal text-center mb-3 sm:mb-4">Let's Collaborate</h2>
          <p className="text-sm sm:text-base text-warm-gray text-center mb-8 sm:mb-12 max-w-2xl mx-auto">
